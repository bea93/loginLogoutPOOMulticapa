...
CREATE DATABASE IF NOT EXISTS DAW213loginLogoutMulticapaPOO;

USE DAW213loginLogoutMulticapaPOO;
...
CREATE USER 'usuarioDAW213loginLogout'@'%' IDENTIFIED BY 'paso';
-- Permisos para la base de datos
GRANT ALL PRIVILEGES ON DAW213loginLogoutMulticapaPOO.* TO 'usuarioDAW213loginLogout'@'%';